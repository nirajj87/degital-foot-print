...
|---|---|
| Email | Breaches, Gravatar/Keybase, GitHub accounts that mention the mailbox, social handle of the local-part, domain of custom mail (not Gmail) |
| Phone | Country/carrier parse, public GitHub mentions, local project files, search links |
| Username / `github:name` / profile URL | Public profile matrix + GitHub card |
